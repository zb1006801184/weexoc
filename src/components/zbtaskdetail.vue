    ...
    <cell class="firstCell">
        ...
        <div class="topDiv1">
           ...
           <div class="rightDivStyle">
            <text style="width: 118px;height: 56px; font-size: 24px;background-color: #FB3C3C;border-radius: 6px;text-align: center;justify-content:center;color: white; ">关注</text>
           </div>
        </div>
        <!-- 文字内容部分 -->
