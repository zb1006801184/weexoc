...
var update = __webpack_require__(11)("414c2beb", content, false, {});
...
exports.default = {
  ...
  methods: {
    textClick: function textClick() {
      weex.requireModule("showLoading").showView({ "1": "2" });
    },

    //push
    pushClick: function pushClick() {
      navigator.push({
        url: 'http://169.254.110.18:8081/dist/next.js',
        animated: 'true'
      });
    },
    show: function show() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("点击自定义的module")]), _vm._v(" "), _c('p', {
    staticClass: " weex-el weex-text",
    attrs: {
      "weex-type": "text",
      "data-evt-click": ""
